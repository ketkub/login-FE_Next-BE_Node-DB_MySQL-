            ...
            >
              ...
              <CardContent className="p-6 h-36 flex flex-col justify-between rounded-tr-xs w-80 mx-auto">
                ...
                {product.InStock <= 0 && (
                  <div className="flex justify-center">
                    <Badge className="bg-red-100 text-red-800">สินค้าหมด</Badge>
                  </div>
                )}
              </CardContent>
              ...
              <CardFooter className="p-6 pt-0 flex justify-center">
                <Button
                  ...
                  className="w-full bg-slate-900 hover:bg-slate-800 dark:bg-gray-900 dark:hover:bg-gray-800 text-white rounded-lg shadow-md transition-colors group/btn cursor-pointer"
                >
